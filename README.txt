...
#-------------------------------------------------------------------------------
Textual information about the project is found in the doc-tATAmI-PC/wiki folder.

Make sure that you first become aware of the information there.

To generate the project's documentation, Run output/javadoc.xml as an Ant Build file.
The documentation will then be found in doc-tATAmI-PC and doc-tATAmI-PC-core (start with the index.html file) 
