...
public class ParserClaim2Val
{
	 ...
	 */
	public ParserClaim2Val()
	{
	}
	/**
	 * Initialize me as an int
	 */
	public ParserClaim2Val(int val)
	{
		ival=val;
	}
	 ...
	 */
	public ParserClaim2Val(double val)
	{
		dval=val;
	}
	 ...
	 */
	public ParserClaim2Val(String val)
	{
		sval=val;
	}
	 ...
	 */
	public ParserClaim2Val(Object val)
	{
		obj=val;
	}
	...
	public ParserClaim2Val(ClaimConstruct claimConstruct) {
		super();
	...
	public ParserClaim2Val(Vector<ClaimConstruct> claimConstructVector) {
		super();
	...
	public ParserClaim2Val(ArrayList<String> stringVector) {
		super();
	...
	public ParserClaim2Val(ClaimBehaviorType claimBehaviorType) {
		super();
