 ...
 ******************************************************************************/
package testing.old.andrei.httpServer;
 ...
 * 
 * <p>
 * NanoHTTPD version 1.21, Copyright &copy; 2001,2005-2011 Jarno Elonen (elonen@iki.fi, http://iki.fi/elonen/) and Copyright &copy; 2010 Konstantinos Togias (info@ktogias.gr, http://ktogias.gr)
 * 
 * <p>
...
public class NanoHTTPD
{
	 ...
	 */
	public static final String	HTTP_OK	= "200 OK", HTTP_REDIRECT = "301 Moved Permanently", HTTP_FORBIDDEN = "403 Forbidden", HTTP_NOTFOUND = "404 Not Found", HTTP_BADREQUEST = "400 Bad Request",
	...
	*/
	...
	static
	{
		StringTokenizer st = new StringTokenizer("css		text/css " + "js			text/javascript " + "htm		text/html " + "html		text/html " + "txt		text/plain " + "asc		text/plain " + "gif		image/gif "
				+ "jpg		image/jpeg " + "jpeg		image/jpeg " + "png		image/png " + "mp3		audio/mpeg " + "m3u		audio/mpeg-url " + "pdf		application/pdf " + "doc		application/msword "
