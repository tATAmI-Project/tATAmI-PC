 ...
 ******************************************************************************/
package sclaim.parser.symbol_table;
...
/**
 * Symbol table prototype designed to support scopes. The main idea is to have a linked list of symbol table prototypes, with the head being
...
public class Prototype implements Serializable
{
	...
	/**
	 * The {@link Prototype} instance of broader scope / outer context / higher level
	 */
	protected Prototype				prev;
	...
	public Prototype(Prototype link)
	{
	...
	/**
	 * puts a new variable, with the specified name and with the associated value in this symbol table prototype if the specified
	 * name is not found in one of the symbol table prototypes of the hierarchy, starting with the current one.
	 * 
	 * @param variable
	...
	{
		Prototype st = getSymbolTablePrototypeContainingKey(variable);
		if(st == null)
	...
	/**
	 * returns the symbol table prototype that contains a certain key (if any, <code>null</code> otherwise)
	 * 
	 * @param variable
	 *            - variable name to be verified
	 * @return - the symbol table prototype which contains a certain key
	 */
	public Prototype getSymbolTablePrototypeContainingKey(ClaimVariable variable)
	{
		for(Prototype st = this; st != null; st = st.prev)
		{
	...
	public HashMap<ClaimVariable, ClaimValue> getTable() {
		return table;
	}
}
