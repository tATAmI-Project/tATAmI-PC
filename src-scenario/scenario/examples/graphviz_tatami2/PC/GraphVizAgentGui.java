...
public class GraphVizAgentGui extends PCDefaultAgentGui
{
	enum ChatComponents {
		SEND, CHATTEXT, CHATLOG, MESSAGEINPUT
	}
	
	public GraphVizAgentGui(AgentGuiConfig configuration)
	{
		...
		JungGraph jungGraph = new JungGraph("defaultGraph", true);
		GraphEditor editor = new GraphEditor(jungGraph);
